...
// was not loaded in eager-loading.
func (e ProductEdges) TransactionsOrErr() ([]*Transaction, error) {
	if e.loadedTypes[1] {
...
// QueryBooth queries the "booth" edge of the Product entity.
func (_m *Product) QueryBooth() *BoothQuery {
	return NewProductClient(_m.config).QueryBooth(_m)
}

// QueryTransactions queries the "transactions" edge of the Product entity.
func (_m *Product) QueryTransactions() *TransactionQuery {
	return NewProductClient(_m.config).QueryTransactions(_m)
}
