...
func HasBoothWith(preds ...predicate.Booth) predicate.Product {
	return predicate.Product(func(s *sql.Selector) {
		step := newBoothStep()
...
func HasTransactions() predicate.Product {
	return predicate.Product(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasTransactionsWith(preds ...predicate.Transaction) predicate.Product {
	return predicate.Product(func(s *sql.Selector) {
